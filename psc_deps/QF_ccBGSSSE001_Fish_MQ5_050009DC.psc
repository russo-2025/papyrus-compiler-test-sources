...
Scriptname QF_ccBGSSSE001_Fish_MQ5_050009DC Extends Quest Hidden
...
fishTank.AddFish(LyretailAnthias, 1)
fishTank.AddFish(Angelfish, 1)
fishTank.UpdateFish()

CompleteAllObjectives()

; Clear the item aliases (this quest does not stop, for dialogue purposes)
Alias_Guide.Clear()
Alias_List.Clear()
;END CODE
EndFunction
...
Ingredient Property LyretailAnthias  Auto  
