...
Event OnEffectStart(Actor Target, Actor Caster)
	player = Game.GetPlayer() ; USSEP 4.3.1 Bug #33741 - OnInit isn't specified as a valid method for ActiveMagicEffect so this call should be done here, and needs to be done regardless of the distance check.
