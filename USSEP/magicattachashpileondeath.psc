...
Event OnDying(Actor Killer)
	MagicNoDistintegrate = game.getFormFromFile(0xEDF, "Skyrim.esm") as keyword
	ActorBase VictimBase = Victim.GetBaseObject() as ActorBase

	if victimBase.hasKeyword(MagicNoDistintegrate)
		TargetisImmune = True		
	elseif ImmunityList == none 
