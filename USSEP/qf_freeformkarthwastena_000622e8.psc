...
;USKP 2.0.7 - Moved here to avoid it blocking the stop call and hanging the quest.
...
;USKP 2.0.5 - Both of the other ending options do this, forgetting here will never get it added back in properly.
;USKP 2.0.7 - Moved here to avoid it blocking the stop call and hanging the quest.
CWQuest.AddGarrisonBackToWar(KarthwastenLocation)
;END CODE
EndFunction
