...
if (Game.GetPlayer().HasLOS(Alias_Hadvar.GetActorReference()) == False) && (GetStageDone(192) == 0)
	Alias_Hadvar.TryTomoveTo(duncgHadvarFailsafeMarker)
EndIf


HouseBlockerMarker.enableNoWait()
Alias_Ralof.TryToEvaluatePackage()
MQ101.SetStage(180)
...
Alias_StormcloakTowerA.TryTokill()
CollisionInnMarker.enableNoWait()

Alias_TowerDoor.GetRef().SetOpen(True)
Alias_TowerCollision.TryToDisableNoWait()
...
;need to clean up
Alias_CivilianMatlara.TryToDisable() ; Added by USKP 1.3.3
Alias_CivilianVilod.TryToDisable() ; Added by USKP 1.3.3
Alias_TowerCollision.TryToDisableNoWait()
AlduinAttackEnableMarker1.enableNoWait()
...
Alias_CivilianGunnar.TryTomoveTo(GunnarMarker8)
Alias_CivilianTorolf.TryTomoveTo(TorolfWoundedMarker)
...
Alias_GeneralTullius.TryTomoveTo(GeneralTulliusDMarker1)
Alias_ImperialSoldier01.tryToEnable()
Alias_ImperialSoldier01.TryTomoveTo(ImperialSoldier01DMarker1)
Alias_CivilianVilod.tryToEnable()
Alias_CivilianVilod.TryTomoveto(VilodWoundedMarker)
...
Alias_CivilianMatlara.TryTomoveto(MatlaraWoundedMarker)
...
Alias_Alduin.TryToDisableNoWait()

If GetStageDone(22) == 1
 SetStage(50)
Else
 Alias_Ralof.TryToMoveTo(MQ101RalofMarker9)
 Alias_TowerDoor.GetRef().SetOpen(False)
 Alias_TowerCollision.TryToEnable()
 SetStage(50)
EndIf
;END CODE
EndFunction
...
if(getStageDone(158) != 1)
  Alias_Hadvar.TryTomoveTo(HadvarCMarkerMoveTo)
endif
...
Alias_Ralof.TryTomoveTo(RalofOutsideKeepMarker1)
