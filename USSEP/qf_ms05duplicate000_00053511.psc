...
Alias_MS05Viarmo.GetActorReference().SetRelationshipRank(Game.GetPlayer(),1)
Alias_MS05Jorn.GetActorReference().SetRelationshipRank(Game.GetPlayer(),1)
Alias_MS05Giraud.GetActorReference().SetRelationshipRank(Game.GetPlayer(),1)
...
Spell Property USLEEPMS05Reward Auto ;USKP 2.1.3 Bug #19392
