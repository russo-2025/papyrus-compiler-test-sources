...
MagicEffect Property UnspecifiedDamageFFAimed Auto ;UDGP 2.0.7
...
Auto State Ready
	...
	;UDGP 2.0.7 - Generic damage detector so Unrelenting Force will register to break the chaurus pods.
	Event OnMagicEffectApply(ObjectReference akCaster, MagicEffect akEffect)
		if( akEffect == UnspecifiedDamageFFAimed )
			GoToState("Done")
		EndIf
	EndEvent
