...
Alias_Ring.GetReference().Enable()
...
; USKP 2.0.3 - Just take it. Blasted game requires 3D on NPCs before they can equip.
Game.GetPlayer().RemoveItem(Alias_Ring.GetReference())
Game.GetPlayer().AddItem(FavorRewardGoldSmall)

;Player is now Kerah's friend
Alias_Kerah.GetActorReference().SetRelationshipRank(Game.GetPlayer(), 1)
