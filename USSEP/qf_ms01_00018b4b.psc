...
Alias_Uaile.GetActorReference().EvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT
...
Alias_Eltrys.GetActorReference().Disable()
Alias_EltrysDead.GetActorReference().Enable()
...
If Alias_Nepos.GetActorReference().IsDead() == False
...
Alias_Betrid.GetActorReference().Kill()
Actor IldeneREF = Alias_Ildene.GetActorReference()
Actor DonnelREF = Alias_Donnel.GetActorReference()
...
Alias_Thonar.GetActorReference().EvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT
...
Alias_Eltrys.GetActorReference().AddItem(LvlQuestReward02Medium)
;END CODE
EndFunction
;END FRAGMENT
...
Alias_ThonarDoor.GetReference().Lock(False)
;END CODE
EndFunction
;END FRAGMENT
...
Alias_Uaile.GetActorReference().AddtoFaction(MS01PlayerEnemyFaction)
Alias_Tynan.GetActorReference().AddtoFaction(MS01PlayerEnemyFaction)
Alias_Morven.GetActorReference().AddtoFaction(MS01PlayerEnemyFaction)
Alias_Nepos.GetActorReference().AddtoFaction(MS01PlayerEnemyFaction)

;clear crime factions
Alias_Uaile.GetActorReference().RemoveFromFaction(CrimeFactionReach)
Alias_Tynan.GetActorReference().RemoveFromFaction(CrimeFactionReach)
Alias_Morven.GetActorReference().RemoveFromFaction(CrimeFactionReach)
Alias_Nepos.GetActorReference().RemoveFromFaction(CrimeFactionReach)
;END CODE
EndFunction
;END FRAGMENT
...
If GetStageDone(48) == 0
  SetObjectiveCompleted(25, 1)
   If GetStageDone(47) == 0 ; Check added by USKP 1.3.3. Don't display "read" objective if you already did that.
