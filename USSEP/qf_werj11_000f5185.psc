...
Function Fragment_6()
;BEGIN CODE
alias_Skjor.TryToMoveTo(alias_TravelMarker1.GetReference())
alias_Aela.TryToMoveTo(alias_TravelMarker1.GetReference())
alias_Njada.TryToMoveTo(alias_TravelMarker1.GetReference())
;END CODE
EndFunction
;END FRAGMENT
...
if( alias_Skjor.GetReference() != None )
...
Function Fragment_7()
;BEGIN CODE
alias_Skjor.TryToEvaluatePackage()
alias_Aela.TryToEvaluatePackage()
alias_Njada.TryToEvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT
