...
Function CheckOutfit()
	...
	if (rnpcActor.IsInInterior())
		...
		if(currentSpace && SunDamageExceptionList.Find(currentSpace) < 0)
			shouldWearHood = true
		else
	...
	if (!shouldWearHood)
		...
		if (rnpcActor.IsEquipped(VampArmor) && !rnpcActor.IsEquipped(Hoodie))
			...
			;rnpcActor.AddItem(Hoodie) Disabled by UDGP 1.2.2 - She's been picking up multiple hoods because of this when EquipItem will give her one if she doesn't already have it.
