...
event onActivate(objectReference ActivateRef)
	...
	elseif ActivateRef == self
		...
		DLC1VQ03BarrierMessage.show() ;UDGP 2.0.1 - Returning a sound instance from the object here isn't valid.
	endif
endEvent
...
Function LowerTheBarrier()
	...
	utility.Wait(0.4)
	;sound.StopInstance(barrierSoundInstance) - UDGP 2.0.1: This is an invalid sound instance.
