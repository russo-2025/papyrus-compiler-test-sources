...
Alias_Pavo.GetActorReference().SetRelationshipRank(Game.GetPlayer(), 1)
Alias_Gat.GetActorReference().SetRelationshipRank(Game.GetPlayer(), 1)

;Pavo now buys ore
Alias_Pavo.TryToAddtoFaction(FavorJobsMineOreFaction)
