...
;/ ***	Unofficial Hearthfire Patch,
	with vanilla lines left in place for easy comparison.
/;
...
;/ ***	Removed by Unofficial Skyrim Patch, replaced below
...
;/ ***	Removed by Unofficial Skyrim Patch, replaced below
   ...
   *** /;
	...
	utility.wait(2)
	currentDriver.SetActorValue("variable01", 0) ; turn it back off [USKP]
...
; ***	Added by Unofficial Skyrim Patch
	Actor player = Game.GetPlayer()
