...
;END AUTOCAST
;BEGIN CODE
kmyQuest.RegisterforSingleUpdateGameTime(1) ;USKP 2.0 - Changed by Shroob; indeally, poll one hour after the player joins College to kick lectures into gear quickly
SetStage(10)
;END CODE
EndFunction
;END FRAGMENT
