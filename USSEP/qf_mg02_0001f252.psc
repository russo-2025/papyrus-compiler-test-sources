...
SetStage(10)
ArnielAlias.Clear() ;USKP 2.0.6 - Prevents him from leaving Saarthal to attend lectures.
;END CODE
EndFunction
;END FRAGMENT
...
ArnielAlias.ForceRefTo(Alias_MG02ArnielAlias.GetActorReference()) ;USKP 2.0.6 - Allows him to go back to lectures.
Stop()
MG03.SetStage(0)
;END CODE
EndFunction
...
ReferenceAlias Property ArnielAlias Auto ;USKP 2.0.6