...
;USSEP 4.3.5 Bug #35017 - This script as written is fine, but for some reason the compiled .pex file in vanilla is broken and doesn't actually execute the code in Fragment 2.