...
Alias_TG05KarliahAlias.GetActorReference().RemoveSpell(pTG05KarliahInvisibilitySpell) ; Added by USKP 2.0 - should have been here from Official patch 1.9
stop()
;END CODE
EndFunction
;END FRAGMENT
...
Spell Property pTG05KarliahInvisibilitySpell Auto
