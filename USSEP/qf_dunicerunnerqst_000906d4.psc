...
;Alias_Bandit02.GetActorRef().Disable() ;USKP 2.0.8 - handled via a parent marker
;Alias_Bandit03.GetActorRef().Disable() ;USKP 2.0.8 - handled via a parent marker
Alias_Bandit04.GetActorRef().Disable()
;Alias_Bandit05.GetActorRef().Disable() ;USKP 2.0.8 - handled via a parent marker
