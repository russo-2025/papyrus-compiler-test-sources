...
Alias_DA14HagravenAlias.TryToDisable() ; USKP 2.0.4
Alias_DA14MorvunskarMapMarker.GetReference().AddToMap()

Alias_DA14Samwell.TryTomoveto(alias_DA14SamEndMarker.GetReference())
Alias_DA14Samwell.TryToenable()
Alias_DA14Samwell.GetActorReference().setghost()
Alias_DA14SanguinesRealmEnabler.TryToenable()
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
Alias_DA14hagravenAlias.GetActorReference().StartCombat(Game.GetPlayer())
;END CODE
EndFunction
;END FRAGMENT
...
alias_DA14Senna.TryTomoveto(alias_DA14Priestess2AwakenMarker.GetReference())
;alias_DA14Orla.TryTomoveto(alias_DA14Priestess2AwakenMarker.GetReference())
Alias_DA14Samwell.TryTodisable()
alias_DA14GiantAlias.TryToEnable()
alias_DA14SammyAlias.TryToEnable()
;alias_DA14GiantAlias.GetActorReference().allowpcdialogue(1)

alias_DA14Wine.TryToenable()
alias_DA14HolyWater.TryToenable()
alias_DA14GiantsClub.TryToenable()
alias_DA14NoteFromSam.TryToenable()
;END CODE
EndFunction
;END FRAGMENT
...
Alias_DA14Samwell.GetReference().PlaceAtMe(SummonFX)
Utility.wait(1)
Alias_DA14Samwell.TryToDisable()
Alias_DA14Sanguine.TryTomoveto(Alias_DA14Samwell.GetReference())
Alias_DA14Sanguine.TryToEnable()
;END CODE
EndFunction
;END FRAGMENT
...
alias_DA14SammyAlias.GetActorReference().allowpcdialogue(1)
alias_DA14Wine.TryTodisable()
alias_DA14HolyWater.TryTodisable()
alias_DA14GiantsClub.TryTodisable()
alias_DA14NoteFromSam.TryTodisable()
;END CODE
EndFunction
;END FRAGMENT
...
Game.GetPlayer().moveto(alias_DA14innmarker.GetReference())
Utility.Wait(1) ; Added by USKP 2.0 to deal with CTDs on some systems.
setObjectiveCompleted(12)
AchievementsQuest.IncDaedricArtifacts()
AchievementsQuest.IncDaedricQuests()
Alias_DA14Sanguine.TryTodisable() ; Added by USKP 2.0
stop()
;END CODE
EndFunction
;END FRAGMENT
...
alias_DA14HagravenAlias.TryToEnable()
alias_DA14HagravenAlias.GetActorReference().allowpcdialogue(1)
Alias_DA14WitchmistGroveMapMarker.GetReference().AddToMap()
;END CODE
EndFunction
;END FRAGMENT
...
Alias_DA14RoricksteadMapmarker.GetReference().AddToMap()
;END CODE
EndFunction
;END FRAGMENT
