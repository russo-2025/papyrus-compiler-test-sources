...
;USLEEP 3.0.1 Bug #19803 - Workaround for inventory reference corruption.
MiscObject Property DLC1LD_AetheriumShard01 Auto
MiscObject Property DLC1LD_AetheriumShard02 Auto
MiscObject Property DLC1LD_AetheriumShard03 Auto
MiscObject Property DLC1LD_AetheriumShard04 Auto
...
Auto State Ready
	...
	Event OnActivate(ObjectReference akActivator)
		if (akActivator == Game.GetPlayer())
			...
			if (animState < 5)
				if (animState == 1 && Game.GetPlayer().GetItemCount(DLC1LD_AetheriumShard01) == 1)
					Game.GetPlayer().RemoveItem(DLC1LD_AetheriumShard01, 1)
					CrestPedestal.GetReference().PlayAnimationAndWait("crest01", "done")
					hasPerformedAction = True
					animState = 2
				EndIf
				if (animState == 2 && Game.GetPlayer().GetItemCount(DLC1LD_AetheriumShard02) == 1)
					Game.GetPlayer().RemoveItem(DLC1LD_AetheriumShard02, 1)
					CrestPedestal.GetReference().PlayAnimationAndWait("crest02", "done")
					hasPerformedAction = True
					animState = 3
				EndIf
				if (animState == 3 && Game.GetPlayer().GetItemCount(DLC1LD_AetheriumShard03) == 1)
					Game.GetPlayer().RemoveItem(DLC1LD_AetheriumShard03, 1)
					CrestPedestal.GetReference().PlayAnimationAndWait("crest03", "done")
					hasPerformedAction = True
					animState = 4
				EndIf
				if (animState == 4 && Game.GetPlayer().GetItemCount(DLC1LD_AetheriumShard04) == 1)
					Game.GetPlayer().RemoveItem(DLC1LD_AetheriumShard04, 1)
