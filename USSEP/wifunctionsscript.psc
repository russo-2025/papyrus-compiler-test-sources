...
; 		debug.trace("WIFunctions AllowDragons(" + LocationToToggle + ") incremented keyword data WIDragonsToggle to: " + keywordData)
		
	Else
; 		debug.trace(" WARNING: WIFunctions AllowDragons(" + LocationToToggle + ") -- keyword WIDragonsToggle does not exist on location.", 2)
...
;	debug.MessageBox("WIFunctions RegisterDragonAttack(" + LocationOfDragonAttack + "," + Dragon + ")")
	...
	;USKP 1.3.3 - Added sanity check due to this being widely used in unassigned locations, causing Papyrus spam.
	if( LocationOfDragonAttack == None )
		return False
	EndIf
