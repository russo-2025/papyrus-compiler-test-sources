...
Function Fragment_7()
;BEGIN CODE
alias_da14startsamwell.TryToEvaluatepackage()
;END CODE
EndFunction
;END FRAGMENT
...
Alias_DA14StartSamwell.TryTomoveto(Alias_InnMarker.GetReference())
;(Alias_DA14StartSamwellPackageMarker.GetRef()).moveto(Alias_InnMarker.GetRef()) - USKP 2.0.1: Can't move this, what are you doing?
Alias_DA14StartSamwell.TryToEnable()
;END CODE
EndFunction
;END FRAGMENT
