...
if dieRoll >= 50
	Alias_Wolf3.GetReference().Disable()
	Alias_Wolf3.GetReference().Delete()
endif
;END CODE
EndFunction
;END FRAGMENT
...
if Alias_Wolf2.GetReference()
	Alias_Wolf2.GetReference().DeleteWhenAble()
endif
if Alias_Wolf3.GetReference()
	Alias_Wolf3.GetReference().DeleteWhenAble()
endif
;END CODE
EndFunction
;END FRAGMENT
