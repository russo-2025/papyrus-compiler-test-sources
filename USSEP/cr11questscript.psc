Scriptname CR11QuestScript extends CompanionsRadiantQuest Conditional
...
ReferenceAlias Property Fragment auto
...
Function Accepted()
	...
	CampTreasureMarker.GetReference().AddItem(Fragment.GetReference())
	;USKP 2.1.2 Bug #19103 - Can return NONE as a location, which can't be reset.
	if( CampTreasureMarker.GetReference().GetParentCell() != None )
...
Function Cleanup()
	Game.GetPlayer().RemoveItem(Fragment.GetReference())
