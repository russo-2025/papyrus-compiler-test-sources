...
Function ReportDeath()
	...
	found = 0
	Actor a = KolbjornEnemy1.GetActorReference()
	if (a != None && (!a.IsDead() && !a.IsCommandedActor() && !a.IsDisabled()))
		...
		EndIf
	EndIf
	a = KolbjornEnemy2.GetActorReference()
	if (a != None && (!a.IsDead() && !a.IsCommandedActor() && !a.IsDisabled()))
		StoreFoundEnemy(a)
		if (found > 5)
			Return
		EndIf
	EndIf
	a = KolbjornEnemy3.GetActorReference()
	if (a != None && (!a.IsDead() && !a.IsCommandedActor() && !a.IsDisabled()))
		StoreFoundEnemy(a)
		if (found > 5)
			Return
		EndIf
	EndIf
	a = KolbjornEnemy4.GetActorReference()
	if (a != None && (!a.IsDead() && !a.IsCommandedActor() && !a.IsDisabled()))
		StoreFoundEnemy(a)
		if (found > 5)
			Return
		EndIf
	EndIf
	a = KolbjornEnemy5.GetActorReference()
	if (a != None && (!a.IsDead() && !a.IsCommandedActor() && !a.IsDisabled()))
		StoreFoundEnemy(a)
		if (found > 5)
			Return
		EndIf
	EndIf	
	a = KolbjornEnemy6.GetActorReference()
	if (a != None && (!a.IsDead() && !a.IsCommandedActor() && !a.IsDisabled()))
		StoreFoundEnemy(a)
		if (found > 5)
			Return
		EndIf
	EndIf
	a = KolbjornEnemy7.GetActorReference()
	if (a != None && (!a.IsDead() && !a.IsCommandedActor() && !a.IsDisabled()))
		StoreFoundEnemy(a)
		if (found > 5)
			Return
		EndIf
	EndIf		
	a = KolbjornEnemy8.GetActorReference()
	if (a != None && (!a.IsDead() && !a.IsCommandedActor() && !a.IsDisabled()))
		StoreFoundEnemy(a)
		if (found > 5)
			Return
		EndIf
	EndIf
	a = KolbjornEnemy9.GetActorReference()
	if (a != None && (!a.IsDead() && !a.IsCommandedActor() && !a.IsDisabled()))
		StoreFoundEnemy(a)
		if (found > 5)
			Return
		EndIf
	EndIf		
	a = KolbjornEnemy10.GetActorReference()
	if (a != None && (!a.IsDead() && !a.IsCommandedActor() && !a.IsDisabled()))
		StoreFoundEnemy(a)
		if (found > 5)
			Return
		EndIf
	EndIf		
	a = KolbjornEnemy11.GetActorReference()
	if (a != None && (!a.IsDead() && !a.IsCommandedActor() && !a.IsDisabled()))
		StoreFoundEnemy(a)
		if (found > 5)
			Return
		EndIf
	EndIf
	a = KolbjornEnemy12.GetActorReference()
	if (a != None && (!a.IsDead() && !a.IsCommandedActor() && !a.IsDisabled()))
		StoreFoundEnemy(a)
		if (found > 5)
			Return
		EndIf
	EndIf
	a = KolbjornEnemy13.GetActorReference()
	if (a != None && (!a.IsDead() && !a.IsCommandedActor() && !a.IsDisabled()))
		StoreFoundEnemy(a)
		if (found > 5)
			Return
		EndIf
	EndIf
	a = KolbjornEnemy14.GetActorReference()
	if (a != None && (!a.IsDead() && !a.IsCommandedActor() && !a.IsDisabled()))
		StoreFoundEnemy(a)
		if (found > 5)
			Return
		EndIf
	EndIf
	a = KolbjornEnemy15.GetActorReference()
	if (a != None && (!a.IsDead() && !a.IsCommandedActor() && !a.IsDisabled()))
		StoreFoundEnemy(a)
		if (found > 5)
			Return
	...
	if (KolbjornEnemy16 != None)
		a = KolbjornEnemy16.GetActorReference()
		if (a != None && (!a.IsDead() && !a.IsCommandedActor() && !a.IsDisabled()))
			StoreFoundEnemy(a)
			if (found > 5)
				Return
			EndIf
		EndIf
		a = KolbjornEnemy17.GetActorReference()
		if (a != None && (!a.IsDead() && !a.IsCommandedActor() && !a.IsDisabled()))
			StoreFoundEnemy(a)
			if (found > 5)
				Return
