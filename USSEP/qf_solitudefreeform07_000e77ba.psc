...
;BEGIN ALIAS PROPERTY USSEPWarhornSpawnMarker
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_USSEPWarhornSpawnMarker Auto
;END ALIAS PROPERTY
...
alias_item.GetReference().EnableNoWait() ;USSEP 4.3.5 Bug #34902
