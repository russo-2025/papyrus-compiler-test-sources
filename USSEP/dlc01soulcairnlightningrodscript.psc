...
EVENT onActivate(objectReference actronaut)
	...
	if actronaut.getItemCount(DLC01SoulcairnLRodGemList) >= 1
		...
		if i == 1
			...
			utility.wait(1.0) ; UDGP 2.0.4 - Allow previous call to finish loading the object.
			...
			disable()
			delete()
			strikeSource.delete() ; UDGP 2.0.4 - This is a placeatme object. Clean up your bloat!
		endif
	else
