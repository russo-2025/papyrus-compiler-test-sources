...
;UDGP 2.0.2 - Map marker is optional.
if( Alias_MapMarker.GetReference() )
	Alias_MapMarker.GetReference().AddToMap()
EndIf
SetObjectiveDisplayed(10)
DLC1Radiant.SetObjectiveCompleted(10) ; Added by UDGP 1.1.4
DLC1Radiant.AddAliasToCrimeFactionForCurrentLocation(Alias_Target) ;USLEEP 3.0.7 Bug #21219
;END CODE
EndFunction
;END FRAGMENT
