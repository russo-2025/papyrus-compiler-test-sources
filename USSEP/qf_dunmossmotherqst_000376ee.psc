...
CompleteAllObjectives() ;USKP 2.0.6
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
;USKP 2.0.2 - His AI already takes care of this, this restraint command leads to more bugs than it solves.
...
Alias_Valdr.GetActorReference().EvaluatePackage()
SetObjectiveCompleted(5) ;USKP 2.0.6
