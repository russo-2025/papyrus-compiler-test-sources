...
Event OnSleepStop(bool abInterrupted)
	if Survival_ModeEnabled.GetValueInt() == 1
		...
		; USCCCP 5.16: Apply Rested when the player is sleeping in a Camping bedroll [Integrated in USSEP 4.2.7]
		ObjectReference CampsiteBed = Game.FindClosestReferenceOfTypeFromRef(game.GetFormFromFile(2051, "ccqdrsse002-firewood.esl") as Activator, PlayerRef, 300.0)

		; Was this quality sleep? (Sleeping indoors)
		bool qualitySleep = PlayerRef.IsInInterior() || Survival_InteriorAreas.HasForm(PlayerRef.GetWorldSpace()) || CampsiteBed != None
