...
Alias_VampireLeader.GetActorReference().SetAV("Aggression", 2)
Alias_Vampire02.GetActorReference().SetAV("Aggression", 2)
if (Alias_Vampire03.GetActorReference() != None)
     Alias_Vampire03.GetActorReference().SetAV("Aggression", 2)
EndIf
;END CODE
EndFunction
;END FRAGMENT
...
if (Alias_Vigilant03.GetActorReference() != None)
