...
;USSEP 4.2.9 Bug #32655: Prevent items from falling off of display racks.
Event OnCellAttach()
	If !IsOneOfItemsOnDisplay()
		ObjectReference fallenItem = Game.FindClosestReferenceOfAnyTypeInListFromRef(itemsToDisplay, GetLinkedRef(LinkedMarkerKeyword), 1000.0)
		If fallenItem != None
