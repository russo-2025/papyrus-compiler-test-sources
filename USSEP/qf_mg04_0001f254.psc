...
ArchMageDoorTwo.Lock(False) ;USKP 2.0.7
;END CODE
EndFunction
;END FRAGMENT
...
ArchMageDoor.Lock()
;USKP 2.0.7
ArchMageDoorTwo.SetLockLevel(255)
ArchMageDoorTwo.Lock()
endif
...
SetStage(10)
Utility.Wait(5) ; USKP 2.0.1 - Insert short delay due to scene being skipped because of Papyrus lag.
MG04UragScene.Start()
;END CODE
EndFunction
;END FRAGMENT
...
ObjectReference Property ArchMageDoorTwo Auto ; USKP 2.0.7 - Quest only locks one door, but there are two, and entering will break the quest.
