...
Scriptname QF_Favor205_0006FE37 Extends Quest Hidden
...
;END AUTOCAST
;BEGIN CODE
Alias_QuestGiver.GetActorReference().RemoveFromFaction(Favor205QuestGiverFaction)
Game.GetPlayer().RemoveItem(Alias_QuestItem.GetReference()) ; USKP 2.0.5 - He'll sell it otherwise.
