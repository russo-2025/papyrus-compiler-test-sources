...
Function Fragment_2()
;BEGIN CODE
;USKP 2.0.2 - Don't stop here. There's an object that handles this elsewhere.
;Stop()
;END CODE
EndFunction
;END FRAGMENT
...
Alias_Forsworn1.GetActorReference().SetAV("Aggression", 2)
Alias_Forsworn2.GetActorReference().SetAV("Aggression", 2)
Alias_Forsworn3.GetActorReference().SetAV("Aggression", 2)
;END CODE
EndFunction
;END FRAGMENT
