scriptname UDGPDurnehviirDragonScript extends actor
{UDGP - Modified version of DragonActorScript specifically for Durnehviir's summon version.}
; UDGP version removes the OnDeath event handling because Durnehviir is a special case. His OnDeath handling takes place in the summon script.
; This was necessary to avoid having one copy of this script get stuck in the Papyrus stacks forever for each time he's summoned.
; _____________
;|			    |
;|    SETUP    |
;|_____________|
