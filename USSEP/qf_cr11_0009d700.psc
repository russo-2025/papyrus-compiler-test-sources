...
Scriptname QF_CR11_0009D700 Extends Quest Hidden
...
;BEGIN ALIAS PROPERTY Fragment
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_Fragment Auto
;END ALIAS PROPERTY
...
Function Fragment_0()
;BEGIN AUTOCAST TYPE CR11QuestScript
Quest __temp = self as Quest
CR11QuestScript kmyQuest = __temp as CR11QuestScript
;END AUTOCAST
;BEGIN CODE
kmyQuest.Setup()
;END CODE
...
;END AUTOCAST
;BEGIN CODE
Alias_SpawnChest.GetReference().RemoveAllItems()
;END CODE
EndFunction
;END FRAGMENT
