...
VigharQuest.SetObjectiveCompleted(10)
...
;USKP 2.1.3
if( Alias_Dengeir.GetActorReference().GetRelationshipRank(Game.GetPlayer()) < 1 )
  Alias_Dengeir.GetActorReference().SetRelationshipRank(Game.GetPlayer(), 1)
endif
;END CODE
EndFunction
;END FRAGMENT
