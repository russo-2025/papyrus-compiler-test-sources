...
;USSEP 4.2.4 Bug #29293: corrections to the previous three lines:
(DLC1DawnguardGateRef1 as Default2StateActivator).SetOpen(true)
(DLC1DawnguardGateRef2 as Default2StateActivator).SetOpen(true)
(DLC1DawnguardGateRef3 as Default2StateActivator).SetOpen(true)
...
;USSEP 4.2.4 Bug #29293: corrections to the previous three lines:
(DLC1DawnguardGateRef1 as Default2StateActivator).SetOpen(false)
(DLC1DawnguardGateRef2 as Default2StateActivator).SetOpen(false)
(DLC1DawnguardGateRef3 as Default2StateActivator).SetOpen(false)
;END CODE
EndFunction
;END FRAGMENT
