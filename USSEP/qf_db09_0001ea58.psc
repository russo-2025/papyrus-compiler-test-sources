...
Alias_SolPenitusEmpGuard1Alias.GetReference().Disable()
Alias_SolPenitusEmpGuard2Alias.GetReference().Disable()
Alias_DB09AmbushGuard1Alias.GetReference().Disable()
Alias_DB09AmbushGuard2Alias.GetReference().Disable()
Alias_DB09AmbushGuard3Alias.GetReference().Disable()
Alias_SolPenitusOutside1Alias.GetReference().Disable() ; Added by USKP 1.3.1
Alias_SolPenitusOutside2Alias.GetReference().Disable() ; Added by USKP 1.3.1
Utility.Wait(5)
Stop()
;END CODE
EndFunction
...
;USKP 2.0.4 - These guys are handled by DB10 Stage 1 enable marker.
