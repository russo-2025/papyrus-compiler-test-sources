...
;USKP 2.0.4 - This is not a side quest and is not supposed to count for the achievement.
...
Function Fragment_5()
;BEGIN CODE
;USSEP 4.2.4 - Tangentially related fix for Bug #29340. The objective needs to be removed from the display if Melka dies.
setObjectiveDisplayed(15,false)
;failAllObjectives()
...
Function Fragment_9()
;BEGIN CODE
if( !Alias_Petra.GetActorReference().IsDead() )
