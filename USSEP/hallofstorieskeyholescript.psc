...
; 			Debug.Trace("Check 1 Passed")
			;USKP 2.0.6 - Reverse the order of these logic checks since the myMiscObject can be set to none.
			if( (allowNonPlayerActivation && actorRef != game.GetPlayer()) || game.GetPlayer().GetItemCount(myMiscObject) >= 1 )
