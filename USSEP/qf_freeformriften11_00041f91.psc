...
;BEGIN ALIAS PROPERTY USKPMarksContainer
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_USKPMarksContainer Auto
;END ALIAS PROPERTY
...
Alias_FFRiften11IndarynAlias.GetActorReference().AddItem(Alias_FFRiften11MarkAlias03.GetRef())
Alias_FFRiften11HofgrirAlias.GetActorReference().AddItem(Alias_FFRiften11MarkAlias02.GetRef())
Alias_FFRiften11BolliAlias.GetActorReference().AddItem(Alias_FFRiften11MarkAlias01.GetRef())
;END CODE
EndFunction
;END FRAGMENT
