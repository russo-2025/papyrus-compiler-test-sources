...
Event OnUpdate()
	;UDGP 2.0.3 - These 2 refs become invalid at some point, don't check them once they are, but let the rest run so it cleans up the crud.
	if( OldHarkon && NewHarkon )
