...
;BEGIN CODE
if( Bard.GetActorReference() != None && Bard.GetActorReference().Is3DLoaded() )
	Bard.GetActorReference().PlayIdle(IdleStop)
EndIf
;END CODE
EndFunction
;END FRAGMENT
...
(BardSongs as BardSongsScript).PlaySong(Bard.GetReference(),ChangeSettings = False)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
if( Bard.GetActorReference() != None && Bard.GetActorReference().Is3DLoaded() )
	Bard.GetActorReference().PlayIdle(IdleFluteStart)
EndIf
;END CODE
EndFunction
;END FRAGMENT
