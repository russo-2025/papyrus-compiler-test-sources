...
bool Property USKPStoreDialogueDelivered Auto Hidden Conditional ;USKP 2.0.8 - Bug #18069
LocationAlias Property CurrentMarriageHouse Auto ;USSEP 4.3.6 Bug #35670
...
Function MoveSpouse (Actor Spouse, ReferenceAlias NewHouse)
	...
	If (!BYOHRelationshipAdoption.IsRunning() || (BYOHRelationshipAdoption as BYOHRelationshipAdoptionScript).AllowSpouseToMove)
		...
		;USSEP Bug #35670 - Will only fill if SpouseCurrentHome matches one of the supported vanilla, HF, or CC/VC houses.
		;For mod use, you should call this fill from your own scripts and make sure SpouseCurrentHome won't match something in the TranslateHouseIntToLoc function.
		Location NewHomeLoc = (BYOHRelationshipAdoption as BYOHRelationshipAdoptionScript).TranslateHouseIntToLoc(SpouseCurrentHome)
		if( NewHomeLoc != None )
			CurrentMarriageHouse.ForceLocationTo( NewHomeLoc )
		endif
	EndIf	
EndFunction
...
Function SpouseShop (Actor Spouse)
	...
	If (Spouse.IsInFaction(JobBlacksmithFaction) == 0) && (Spouse.IsInFaction(JobSpellFaction) == 0) && (Spouse.IsInFaction(JobInnkeeperFaction) ==0) && (Spouse.IsInFaction(JobApothecaryFaction) == 0) && (Spouse.IsInFaction(JobMiscFaction) == 0)
		...
		;Spouse.AddtoFaction(JobMerchantFaction) - USKP 2.0.1: Prevents the spouse from paying off profits before they've established the store.
	EndIf
...
Function UpdateSpouseHouseInt()
	if (SolitudeHouse.GetActorReference() != None)
		SpouseCurrentHome = 1
	ElseIf (WindhelmHouse.GetActorReference() != None)
		SpouseCurrentHome = 2
	ElseIf (MarkarthHouse.GetActorReference() != None)
		SpouseCurrentHome = 3
	ElseIf (RiftenHouse.GetActorReference() != None)
		SpouseCurrentHome = 4
	ElseIf (WhiterunHouse.GetActorReference() != None)
		SpouseCurrentHome = 5
	ElseIf (FalkreathHouse.GetActorReference() != None)
		SpouseCurrentHome = 6
	ElseIf (HjaalmarchHouse.GetActorReference() != None)
		SpouseCurrentHome = 7
	ElseIf (PaleHouse.GetActorReference() != None)
		SpouseCurrentHome = 8
	; Check CC Houses
	ElseIf (CCHouse01.GetActorReference() != None)
		SpouseCurrentHome = 101
	ElseIf (CCHouse02.GetActorReference() != None)
		SpouseCurrentHome = 102
	ElseIf (CCHouse03.GetActorReference() != None)
		SpouseCurrentHome = 103
	ElseIf (CCHouse04.GetActorReference() != None)
		SpouseCurrentHome = 104
	ElseIf (CCHouse05.GetActorReference() != None)
		SpouseCurrentHome = 105
	ElseIf (CCHouse06.GetActorReference() != None)
		SpouseCurrentHome = 106
	ElseIf (CCHouse07.GetActorReference() != None)
		SpouseCurrentHome = 107
	ElseIf (CCHouse08.GetActorReference() != None)
		SpouseCurrentHome = 108
	ElseIf (CCHouse09.GetActorReference() != None)
		SpouseCurrentHome = 109
	ElseIf (CCHouse10.GetActorReference() != None)
		SpouseCurrentHome = 110
	ElseIf (CCHouse11.GetActorReference() != None)
		SpouseCurrentHome = 111
	ElseIf (CCHouse12.GetActorReference() != None)
		SpouseCurrentHome = 112
	ElseIf (CCHouse13.GetActorReference() != None)
		SpouseCurrentHome = 113
	ElseIf (CCHouse14.GetActorReference() != None)
		SpouseCurrentHome = 114
	ElseIf (CCHouse15.GetActorReference() != None)
		SpouseCurrentHome = 115
	ElseIf (CCHouse16.GetActorReference() != None)
		SpouseCurrentHome = 116
	ElseIf (CCHouse17.GetActorReference() != None)
		SpouseCurrentHome = 117
	ElseIf (CCHouse18.GetActorReference() != None)
		SpouseCurrentHome = 118
	ElseIf (CCHouse19.GetActorReference() != None)
		SpouseCurrentHome = 119
	ElseIf (CCHouse20.GetActorReference() != None)
