...
Alias_Forsworn4.GetReference().DeleteWhenAble()
Alias_Orc1.GetReference().DeleteWhenAble()
Alias_Orc2.GetReference().DeleteWhenAble()
Alias_Orc3.GetReference().DeleteWhenAble()
