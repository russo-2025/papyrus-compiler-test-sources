...
; 			debug.trace("SalmaLink = "+self.getLinkedRef(SalmaLink))
			...
			;USKP 2.0.3 - Unnecessary casts here before. We have the aliases, use the proper functions.
			questScript.Alias_Beem_Ja.TryToEvaluatePackage()
			questScript.Alias_Salma.TryToEvaluatePackage()
