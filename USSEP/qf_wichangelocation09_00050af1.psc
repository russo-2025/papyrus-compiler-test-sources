...
;USKP 2.0.1 - Sanity checks. You won't always be close to guards.
if( Alias_Guard1.GetActorReference() != None )
 Alias_Guard1.RegisterForSingleLOSGain(Alias_Guard1.GetActorReference(), DragonActor)
EndIf
if( Alias_Guard2.GetActorReference() != None )
 Alias_Guard2.RegisterForSingleLOSGain(Alias_Guard2.GetActorReference(), DragonActor)
EndIf
if( Alias_Guard3.GetActorReference() != None )
