...
;These 3 variables added by the USKP to create a workaround for the bug in the game engine that allows "Say Once" topics to be repeated. Markarth had an item available to check enable state on.
bool Property USKPSolitudeTurnedIn = False Auto Conditional
bool Property USKPWhiterunTurnedIn = False Auto Conditional
bool Property USKPWindhelmTurnedIn = False Auto Conditional

;USKP 2.0.7 - Still more variables because the dialogue for these things keeps resetting due to the Say Once bug.
bool Property USKPBurglaryJobsIntro = False Auto Conditional
bool Property USKPShillJobsIntro = False Auto Conditional
bool Property USKPNumbersJobsIntro = False Auto Conditional
bool Property USKPFishingJobsIntro = False Auto Conditional
bool Property USKPSweepJobsIntro = False Auto Conditional
bool Property USKPBedlamJobsIntro = False Auto Conditional
bool Property USKPHeistJobsIntro = False Auto Conditional
