...
DA13s14Marker.Disable() ;USLEEP 3.0.7 Bug #21293
Stop() ;Added by USKP
dunBthardamzQST.Stop() ;USKP 2.1.2 Bug #19131
;END CODE
EndFunction
;END FRAGMENT
...
DA13s14Marker.Enable() ;USLEEP 3.0.7 Bug #21293
;END CODE
EndFunction
;END FRAGMENT
...
Quest Property dunBthardamzQST Auto ;USKP 2.1.2 Bug #19131

ObjectReference Property DA13s14Marker Auto ;USLEEP 3.0.7 Bug #21293
