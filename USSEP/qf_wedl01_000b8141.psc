...
Scriptname QF_WEDL01_000B8141 Extends Quest Hidden
...
;USKP 2.0.1 - This stage can possibly get called after Talsgar gets loaded out of memory and the encounter terminates.
if( self.IsRunning() )
  setstage(100)
EndIf
;END CODE
