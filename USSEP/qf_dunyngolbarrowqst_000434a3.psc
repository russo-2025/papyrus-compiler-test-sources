...
Function Fragment_0()
;BEGIN CODE
;alias_mote01.getReference().activate(game.getPlayer())
...
Function Fragment_5()
;BEGIN CODE
alias_mote01.getReference().activate(game.getPlayer()) ; USKP 2.0.1 - The way this was set before did not work.
