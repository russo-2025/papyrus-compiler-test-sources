...
;USKP 1.3.2 Added this function to make the Crimson Nirnroots count themselves properly.
Function CountRoots()
	float CurrentCount = Game.GetPlayer().GetItemCount(pNirnrootRed)
	
	if( GetStage() == 10 && CurrentCount > 0 )
		SetStage(15)
	EndIf
	
	if( GetStage() == 15 )
		pNN01Count.Value = CurrentCount
...
;All of this. You see this mess? THIS MESS RIGHT HERE? Yeah. It. Does. Not. Work. GotARoot() and LostARoot() are no longer being called.
Function GotARoot()
