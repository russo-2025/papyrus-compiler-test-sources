...
Event OnEffectFinish(Actor akTarget, Actor akCaster)
	;UDBP 2.0.2 - According to SMKViper, it isn't necessary to unregister these updates since the effect instance will be destroyed.
	;Besides, this being here is filling Papyrus logs with non-native object errors, indicating it's been destroyed by this point anyway.
	;UnregisterForUpdate()
	PlayerRef.removeSpell(DLC2abApoWaterDamageActual)
