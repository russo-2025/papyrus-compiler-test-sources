...
; 	Debug.Trace("CRQ CR06: Starting CR06 from story script.")
	if     (akKeyword == CRSkjor)
		Questgiver.ForceRefTo(Skjor.GetActorReference())
	elseif (akKeyword == CRVilkas)
		Questgiver.ForceRefTo(Vilkas.GetActorReference())
	endif
...
Function Setup()
	Criminal.GetActorReference().Disable()
	parent.Setup()
EndFunction

Function Accepted()
	Criminal.GetActorReference().Enable()
	parent.Accepted()
EndFunction
