...
Alias_KarliahAlias.GetActorReference().EvaluatePackage()
...
Alias_ValdAlias.GetActorReference().Enable()
Alias_TG07RampMarker.GetReference().Enable() ;USKP 2.0.5 - The ramp trigger needs to be separated.
...
;USSEP 4.3.7 Bug #36238
Alias_FalmerPlansAlias.GetReference().EnableNoWait()
;USKP 2.0.2 - There is no objective 45
...
;BEGIN CODE
;Vald Left
Alias_ValdAlias.GetActorReference().Disable()
...
Alias_ValdAlias.GetActorReference().RemoveItem(kmyQuest.pTG07Key,1)
Alias_ValdAlias.GetActorReference().EvaluatePackage()
kmyQuest.pTG07ValdEnabler.Disable() ; USKP 2.0.4 - Kill the triggers to prevent hostility after freeing his debt.
;END CODE
EndFunction
;END FRAGMENT
...
Alias_BrynjolfAlias.GetActorReference().EvaluatePackage()
...
Alias_KarliahAlias.GetActorReference().Enable()
Alias_MercerAlias.GetActorReference().Disable()
Alias_BrynjolfAlias.GetActorReference().moveto(kmyQuest.pTG07BrynjolfStartMarker)
Alias_DelvinAlias.GetActorReference().moveto(kmyQuest.pTG07DelvinStartMarker)
Alias_VexAlias.GetActorReference().moveto(kmyQuest.pTG07VexStartMarker)
pTG07Trigger.Enable()
