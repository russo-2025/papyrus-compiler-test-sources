...
;BEGIN ALIAS PROPERTY Vald
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_Vald Auto
;END ALIAS PROPERTY
...
Game.GetPlayer().RemoveItem(Alias_FVDQuillAlias.GetReference())
if( !Alias_Vald.GetActorReference().IsDead() )
 Game.GetPlayer().AddItem(Alias_FVDDebtAlias.GetReference())
endif
if( Alias_Vald.GetActorReference().IsDead() )
 SetStage(200)
endif
