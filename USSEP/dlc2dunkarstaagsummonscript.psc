...
Quest Property DLC2dunKarstaagQST Auto ;UDBP 2.0.1
...
Event OnUpdate()
	;UDBP 2.0.1 - This looks like it shouldn't be running after the quest is over.
	if( !DLC2dunKarstaagQST.IsRunning() )
		UnregisterForUpdate()
		Return
	EndIf
