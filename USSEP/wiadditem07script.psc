...
; 	debug.trace(self + "PayPlayer( " + Payment1or2 + ")")
	...
	;USKP 2.0.1 - Changing this to remove one instance of the base object type since you could have long ago sold off or destroyed the specific alias copy.
	PlayerRef.RemoveItem(ItemBase, 1)
EndFunction
