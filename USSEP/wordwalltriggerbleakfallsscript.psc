...
State done
	;USSEP 4.2.7 Bug #31773 - This script should disable the trigger but didn't. All other word walls using the generic script call for this during their "done" state.
	Event OnBeginState()
		self.disable()
	EndEvent
	;do nothing
