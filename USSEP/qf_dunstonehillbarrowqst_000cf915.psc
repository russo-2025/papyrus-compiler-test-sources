...
;USKP 2.0.1 - Cannot send activate commands using None. Player seems appropriate here.
;USKP 2.1.3 - Bug #19441
Alias_DiningHallBandit1.GetActorReference().Activate(USKPDummyActivator)
Alias_DiningHallBandit2.GetActorReference().Activate(USKPDummyActivator)
Alias_BridgeBandit1.GetActorReference().Activate(USKPDummyActivator)
Alias_BridgeBandit2.GetActorReference().Activate(USKPDummyActivator)
;END CODE
EndFunction
;END FRAGMENT
...
Alias_Eisa.GetActorReference().StartCombat(Game.GetPlayer())
Utility.Wait(0.5)
Alias_Eisa.GetActorReference().EvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT
...
if (!Game.GetPlayer().HasLoS(Alias_BridgeBandit1.GetActorReference()))
     Alias_BridgeBandit1.GetActorReference().Disable()
EndIf
;END CODE
EndFunction
;END FRAGMENT
...
Alias_Pursuer1.GetActorReference().DamageAV("Health", (Alias_Pursuer1.GetActorReference().GetAV("Health") - 1))
Alias_Pursuer2.GetActorReference().DamageAV("Health", (Alias_Pursuer2.GetActorReference().GetAV("Health") - 1))
Alias_Pursuer3.GetActorReference().DamageAV("Health", (Alias_Pursuer3.GetActorReference().GetAV("Health") - 1))
FleeScene.Start()
Alias_Eisa.GetActorReference().EvaluatePackage()
Utility.Wait(5)
PursuerScene.Start()
...
if (GetStageDone(1))
   SetStage(8)
EndIf
Alias_Kyr.GetActorReference().Kill()
Utility.Wait(0.5)
Alias_KyrSoulWitchlight.GetReference().MoveTo(Alias_Kyr.GetActorReference(), 25, 25, 100)
...
Alias_PaleLady.GetActorReference().Activate(Alias_Rajirr.GetActorReference())
Alias_Rajirr.GetActorReference().StartCombat(Alias_PaleLady.GetActorReference())
Alias_PaleLady.GetActorReference().StartCombat(Alias_Rajirr.GetActorReference())
if (GetStageDone(1))
   SetStage(9)
EndIf
;END CODE
...
Alias_Eisa.GetActorReference().RemoveItem(EisaJournalBase, 1, True)
...
if (Alias_Eisa.GetActorReference().GetItemCount(EisaJournalBase) > 0)
   ObjectReference journal = Alias_EisaJournalFallbackSpawnPoint.GetReference().PlaceAtMe(EisaJournal, 1)
   Alias_EisaJournal.ForceRefTo(journal)
EndIf

;Disable and delete Eisa when the player enters the ruins.
Alias_Eisa.GetActorReference().Disable()
Alias_Eisa.GetActorReference().Delete()
...
Alias_Eisa.GetActorReference().EvaluatePackage()
Alias_Eisa.GetActorReference().SetAV( "Aggression", 1 ) ; USSEP 4.2.9 Bug #32850
;END CODE
EndFunction
;END FRAGMENT
...
;USKP 2.0.1 - Cannot send activate commands using None. Player seems appropriate here.
;USKP 2.1.3 - Bug #19441
Alias_StoreroomBandit1.GetActorReference().Activate(USKPDummyActivator)
Alias_StoreroomBandit2.GetActorReference().Activate(USKPDummyActivator)
;END CODE
EndFunction
;END FRAGMENT
...
PaleLadyFaction.SetEnemy(PlayerFaction)
Utility.Wait(0.5)
Alias_RajirrSoulWitchlight.GetReference().MoveTo(Alias_Rajirr.GetActorReference(), 25, 25, 100)
...
;USKP 2.0.5 - Cannot send activate commands using None. Player seems appropriate here.
;USKP 2.1.3 - Bug #19441
Alias_BridgeBandit1.GetActorReference().Activate(USKPDummyActivator)
Alias_BridgeBandit2.GetActorReference().Activate(USKPDummyActivator)
;END CODE
...
ObjectReference Property USKPDummyActivator Auto ;USKP 2.1.3 Bug #19441
