...
;BEGIN ALIAS PROPERTY ThalmorGuard
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_ThalmorGuard Auto
;END ALIAS PROPERTY
...
ThalmorInterrogator.disable()
Alias_ThalmorGuard.GetActorRef().evaluatepackage()
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
WhiterunHouseGrayMane.SetPublic(false) ;USKP 2.1.3 Bug #19387
stop()
...
;BEGIN CODE
SetObjectiveCompleted(30,1) ;USLEEP 3.0.3 Bug #19993
SetObjectiveCompleted(40,1)
SetObjectiveCompleted(45,1) ;Objective for peaceful solution fixed by USKP
SetObjectiveCompleted(50,1)
...
Actor Property ThalmorInterrogator  Auto  

Cell Property WhiterunHouseGrayMane Auto ;USKP 2.1.3 Bug #19387
