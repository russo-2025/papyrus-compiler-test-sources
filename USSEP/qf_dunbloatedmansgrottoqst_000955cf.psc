...
Alias_Hunter02_Eriana.GetActorReference().SetAV("Variable06", 1)
Alias_Hunter02_Eriana.GetActorReference().EvaluatePackage()
Alias_Hunter02_Yar.GetActorReference().SetAV("Variable06", 1)
Alias_Hunter02_Yar.GetActorReference().EvaluatePackage()
Alias_Hunter02_Torkild.GetActorReference().SetAV("Variable06", 1)
Alias_Hunter02_Torkild.GetActorReference().EvaluatePackage()
;Alias_Hunter02_Viding.GetActorReference().SetAV("Variable06", 1)
;Alias_Hunter02_Viding.GetActorReference().EvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT
...
Alias_Sinding.GetActorReference().EvaluatePackage()
Alias_Hunter03_Ahjisi.GetActorReference().SetAV("Variable06", 1)
Alias_Hunter03_Ahjisi.GetActorReference().EvaluatePackage()
Alias_Hunter03_Heratar.GetActorReference().SetAV("Variable06", 1)
Alias_Hunter03_Heratar.GetActorReference().EvaluatePackage()
;Alias_Hunter03_Thjollod.GetActorReference().SetAV("Variable06", 1)
;Alias_Hunter03_Thjollod.GetActorReference().EvaluatePackage()
Alias_Hunter03_JSava.GetActorReference().SetAV("Variable06", 1)
Alias_Hunter03_JSava.GetActorReference().EvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT
...
Alias_Hunter03_Ahjisi.GetActorReference().RemoveFromFaction(HunterStallFaction)
Alias_Hunter03_Ahjisi.GetActorReference().EvaluatePackage()
Alias_Hunter03_Heratar.GetActorReference().RemoveFromFaction(HunterStallFaction)
Alias_Hunter03_Heratar.GetActorReference().EvaluatePackage()
;Alias_Hunter03_Thjollod.GetActorReference().RemoveFromFaction(HunterStallFaction)
;Alias_Hunter03_Thjollod.GetActorReference().EvaluatePackage()
Alias_Hunter03_JSava.GetActorReference().RemoveFromFaction(HunterStallFaction)
Alias_Hunter03_JSava.GetActorReference().EvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT
...
Alias_Hunter02_Eriana.GetActorReference().RemoveFromFaction(HunterStallFaction)
Alias_Hunter02_Yar.GetActorReference().RemoveFromFaction(HunterStallFaction)
Alias_Hunter02_Torkild.GetActorReference().RemoveFromFaction(HunterStallFaction)
;Alias_Hunter02_Viding.GetActorReference().RemoveFromFaction(HunterStallFaction)
;END CODE
EndFunction
;END FRAGMENT
...
Alias_Hunter01_Rissing.GetActorReference().RemoveFromFaction(HunterStallFaction)
;Alias_Hunter01_Mazgak.GetActorReference().RemoveFromFaction(HunterStallFaction)
Alias_Hunter01_Tsrasuna.GetActorReference().RemoveFromFaction(HunterStallFaction)
;END CODE
EndFunction
;END FRAGMENT
...
Alias_Sinding.GetActorReference().EvaluatePackage()
Alias_Hunter01_Rissing.GetActorReference().SetAV("Variable06", 1)
Alias_Hunter01_Rissing.GetActorReference().EvaluatePackage()
;Alias_Hunter01_Mazgak.GetActorReference().SetAV("Variable06", 1)
;Alias_Hunter01_Mazgak.GetActorReference().EvaluatePackage()
Alias_Hunter01_Tsrasuna.GetActorReference().SetAV("Variable06", 1)
Alias_Hunter01_Tsrasuna.GetActorReference().EvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT
...
if (DA05.GetStageDone(100))
   Alias_Sinding.GetActorReference().Disable()
EndIf
Stop()
;END CODE
EndFunction
...
Alias_Sinding.GetActorReference().SetAV("Variable06", 1)
...
Alias_Hunter00_JKier.GetActorReference().Kill()
Alias_Sinding.GetActorReference().Enable()
;END CODE
EndFunction
;END FRAGMENT
...
;USKP 2.0.1 - Several statements relating to content cut from the game have been commented out above.
;USKP 2.0.7 - Several more statements relating to the same cut content have been commented out.
...
ReferenceAlias Property DA05SindingHuman Auto
