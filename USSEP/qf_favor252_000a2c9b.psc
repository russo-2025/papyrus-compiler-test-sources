...
Scriptname QF_Favor252_000A2C9B Extends Quest Hidden
...
Alias_QuestGiver.GetActorReference().RemoveFromFaction(Favor252QuestGiverFaction)
...
USKP_HouseCarlBedroomEnable.Enable()
...
If FavorJarlsMakeFriends.GetStageDone(35)
  SetStage(20)
EndIf
;END CODE
EndFunction
...
FavorJarlsMakeFriends.SetStage(30)

;Player already has the house
If HousePurchase.SolitudeHouseVar >= 1
  SetStage(15)
EndIf
;END CODE
EndFunction
