...
Alias_Follower.TryToAddToFaction(BYOHHouseStewardNoForcegreet)
;END CODE
EndFunction
;END FRAGMENT
...
if Alias_HouseLocation.GetLocation() == BYOHHouse1Location
	BYOHHouseBuilding.HireSteward(0, Alias_Follower.GetActorReference())
elseif Alias_HouseLocation.GetLocation() == BYOHHouse2Location
	BYOHHouseBuilding.HireSteward(1, Alias_Follower.GetActorReference())
elseif Alias_HouseLocation.GetLocation() == BYOHHouse3Location
	BYOHHouseBuilding.HireSteward(2, Alias_Follower.GetActorReference())
endif
...
;debug.trace(self + "followerathouse1=" + alias_FollowerAtHouse1.GetReference())
;debug.trace(self + "followerathouse2=" + alias_FollowerAtHouse2.GetReference())
;debug.trace(self + "houseLocation=" + alias_houselocation.GetLocation())

if Alias_Follower.GetReference() == None
