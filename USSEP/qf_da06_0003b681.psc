...
DA06EnableParent.Disable() ; Added by USKP 1.2.5
Stop()
;END CODE
EndFunction
;END FRAGMENT
...
Function Fragment_8()
;BEGIN CODE
;SetObjectiveCompleted(30,1) - USKP 2.0.1: Invalid objective
;SetObjectiveDisplayed(40,1) - USKP 2.0.1: Invalid objective
;END CODE
EndFunction
;END FRAGMENT
...
Function Fragment_6()
;BEGIN CODE
;SetObjectiveCompleted(20,1) - USKP 2.0.1: Invalid objective
;SetObjectiveDisplayed(30,1) - USKP 2.0.1: Invalid objective
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
;SetObjectiveCompleted(40,1) - USKP 2.0.1: Invalid objective
...
USLEEPDA06EssentialSlotForGularzob.Stop() ;USKP 2.0.8 Bug #17701
;END CODE
EndFunction
;END FRAGMENT
...
;SetObjectiveDisplayed(20,1) - USKP 2.0.1: Invalid objective
;END CODE
EndFunction
;END FRAGMENT
...
Quest Property USLEEPDA06EssentialSlotForGularzob Auto ;USKP 2.0.8
