...
;BEGIN ALIAS PROPERTY UDGPLetterChest
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_UDGPLetterChest Auto
;END ALIAS PROPERTY
...
Function Fragment_0()
;BEGIN CODE
Alias_City.GetLocation().setKeywordData(DLC1RV03KillLocation, 1) ; UDGP 1.2.1 moved here
DLC1Radiant.QuestAccepted(self)
Game.GetPlayer().AddItem(DLC1RV03HunterArmor)
Game.GetPlayer().AddItem(Alias_Letter.GetReference())
if( Alias_MapMarker.GetReference() ) ;USSEP 4.3.7 Bug #36132
