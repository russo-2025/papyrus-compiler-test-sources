...
;BEGIN CODE
;Completed
Player.RemoveInventoryEventFilter(pTeeth) ;Added by USKP
Player.RemoveItem(pTeeth,5)
Player.AddItem(pSpelltomeList,1)
Player.AddItem(pPheasantRaw,5)
pThaneCount.Value += 1
pFFRTQS.ThaneCheck()
Alias_FFRiften07MariseAlias.GetActorRef().SetRelationshipRank(Player, 1)
