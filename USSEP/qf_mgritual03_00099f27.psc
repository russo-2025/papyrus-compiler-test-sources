...
Alias_DremoraAlias.GetReference().Disable() ; Added by USKP 1.2.4
MGRitual03LightRef.Disable()                          ; Added by USKP 1.2.4
...
MGRitualDremoraFaction.SetAlly(PlayerFaction)
MGRitualDremoraFaction.SetAlly(CollegeofWinterholdFaction)
;USSEP 4.1.5 Bug #25132
MGRitualDremoraFaction.SetAlly(BladesFaction)
MGRitualDremoraFaction.SetAlly(DA03BarbasFaction)
;END CODE
EndFunction
;END FRAGMENT
...
Faction Property BladesFaction Auto ; USSEP 4.1.5 Bug #25132

Faction Property DA03BarbasFaction Auto ; USSEP 4.1.5 Bug #25132
