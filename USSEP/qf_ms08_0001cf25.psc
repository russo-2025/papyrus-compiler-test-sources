...
;SetObjectiveDisplayed(155) - USKP 2.0.1 - Invalid objective
;END CODE
EndFunction
;END FRAGMENT
...
SetObjectiveCompleted(20) ;USSEP 4.1.7 Bug #25774
endif
If IsObjectiveDisplayed(21)
SetObjectiveCompleted(21)
endif
if IsObjectivedisplayed(25)
SetObjectiveCompleted(25) ;USSEP 4.1.7 Bug #25774
endif
...
Alias_DungeonLoc.Clear()
Alias_WhiterunWarrior01.GetReference().Disable()
Alias_WhiterunWarrior02.GetReference().Disable()
Alias_MS08QuestActiveMarker.GetReference().Disable()
Alias_MS08QuestInactiveMarker.GetReference().Enable()
Stop()
;END CODE
EndFunction
;END FRAGMENT
...
;SetObjectiveCompleted(155) - USKP 2.0.1 - Invalid objective
...
;USKP 2.0.7 - Kematu is disabled by the MS08QuestActiveMarker call below.
...
;BEGIN CODE
setObjectiveCompleted(25)
SetObjectiveCompleted(75) ; USKP 2.0.4 - BGS #152
SetObjectiveDisplayed(100)
...
;USKP 2.0.7 - Get Saddia to run the right package and head for the inn.
Alias_Saadia.TryToEvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT
