...
;BEGIN CODE
UnRegisterForUpdate()
DBEntranceQuest.Stop() ; All from here down added by USKP
if( Alias_Astrid.GetActorReference().IsDead() == 0 )
  Alias_DB02Captive1Alias.TryToDisable()
  Alias_DB02Captive2Alias.TryToDisable()
  Alias_DB02Captive3Alias.TryToDisable()
endif
;END CODE
EndFunction
;END FRAGMENT
