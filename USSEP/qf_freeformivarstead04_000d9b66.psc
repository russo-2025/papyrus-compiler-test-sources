...
;USKP 2.0.5 - Take the sack, because it can be dropped later and has no havok.
Alias_FFI04ChestAlias.GetReference().RemoveItem(Alias_FFI04SackAlias.GetReference())
Stop()
;END CODE
EndFunction
;END FRAGMENT
