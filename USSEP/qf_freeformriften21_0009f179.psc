...
; Added by USKP
Game.GetPlayer().RemoveItem(Alias_FFRIften21Journal01Alias.GetRef())
Game.GetPlayer().RemoveItem(Alias_FFRIften21Journal02Alias.GetRef())
Game.GetPlayer().RemoveItem(Alias_FFRIften21Journal03Alias.GetRef())
Game.GetPlayer().RemoveItem(Alias_FFRIften21Journal04Alias.GetRef())
pFFRTQS.ThaneCheck()
...
Function Fragment_1()
;BEGIN AUTOCAST TYPE FFRiften21QuestScript
Quest __temp = self as Quest
FFRiften21QuestScript kmyQuest = __temp as FFRiften21QuestScript
;END AUTOCAST
;BEGIN CODE
