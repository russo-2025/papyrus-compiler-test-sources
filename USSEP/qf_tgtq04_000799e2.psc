...
Alias_dunUtteringHillsEnableMarker.TryToDisable() ; Added by USKP 1.3.3 to return the dungeon to normal.
Stop()
;END CODE
EndFunction
;END FRAGMENT
...
Alias_dunUtteringHillsEnableMarker.TryToEnable()
;USSEP 4.2.2 Bug #27590
...
Alias_TGTQ04NiranyeAlias.TryToRemoveFromFaction(pCrimeFactionWindhelm)
Alias_TGTQ04NiranyeAlias.TryToAddToFaction(pTGTQ04EnemyFaction)
Alias_TGTQ04NiranyeAlias.GetActorReference().SetAv("Aggression",2)
Alias_TGTQ04NiranyeAlias.GetActorReference().StartCombat(Game.GetPlayer())
;END CODE
EndFunction
;END FRAGMENT
