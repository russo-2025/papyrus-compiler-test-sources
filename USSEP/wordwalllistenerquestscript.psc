...
{Called by WordWallTriggerScript}
	...
	Location MarkerLoc = LocRefMarkerAlias.GetReference().GetCurrentLocation()
	;debug.Trace( "Quest: " + Self + " MarkerLoc: " + MarkerLoc + " PlayerLoc: " + PlayerLoc )
	
;	if( PlayerLoc == MarkerLoc )
