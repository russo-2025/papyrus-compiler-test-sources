...
bool Function IsElf()
	...
	;USKP 1.3.0 Bug #11882
	if (me.GetRace() == da04script.Altmer || me.GetRace() == da04script.AltmerVampire)
		return true
	elseif (me.GetRace() == da04script.Bosmer || me.GetRace() == da04script.BosmerVampire)
		return true
	elseif (me.GetRace() == da04script.Dunmer || me.GetRace() == da04script.DunmerVampire)
		return true
	elseif (me.GetRace() == da04script.Falmer)
		return true
	elseif (me.GetRace() == da04script.Orsimer || me.GetRace() == da04script.OrsimerVampire)
		return true
	endif
