...
EVENT onLoad()
	if( MS06.GetStageDone(150) == 1 )
		GoToState( "USKPDoneWithQuest" )
		Return
	EndIf
...
State USKPDoneWithQuest ;Just do a whole lot of nothing here since this is the only way to silence the script from repeating log spam.
	Event onLoad()
	EndEvent
...
FUNCTION setUpAliases()
	;USKP 2.0.3 - Corrected the B series setup, they were all trying to set up #2 when all 3 are actually called for.
	...
	WaveB01 = questScript.Alias_WaveB_Enemy01.getReference()
	WaveB02 = questScript.Alias_WaveB_Enemy02.getReference()
	WaveB03 = questScript.Alias_WaveB_Enemy03.getReference()
	WaveC01 = questScript.Alias_WaveC_Enemy01.getReference()
	WaveC02 = questScript.Alias_WaveC_Enemy02.getReference()
	WaveC03 = questScript.Alias_WaveC_Enemy03.getReference()
endFUNCTION
