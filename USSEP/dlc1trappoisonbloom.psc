...
;UDGP 2.0.9 - We're reviving this for Bug #18465 to get these things to respawn properly.
event onReset()
...
State Reset
	event onBeginState()
		...
		;debug.Trace(self + ": anim event End received in state Active")
		;UDGP 1.2.1 added check for empty warning sound.
		if( warningSound )
