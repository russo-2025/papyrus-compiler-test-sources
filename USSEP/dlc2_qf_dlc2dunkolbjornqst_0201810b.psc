...
WordWall.Enable() ; UDBP 2.0.1 - Word wall had an enable parent before. tsk tsk.
...
CloakedSpider.Enable() ; UDBP 2.0.1 - This spider was wrongly tied to an enable parent.
...
ObjectReference Property WordWall Auto
Actor Property CloakedSpider Auto
