...
if( DB05.GetStage() >= 200 )
  Alias_TGTQ02ErikurAlias.GetActorReference().GetActorBase().SetEssential (false)
endif
Alias_TGTQ02ChestAlias.GetReference().RemoveItem(Alias_TGTQ02BalmoraBlueAlias.GetReference()) ;USKP 2.1.3 Bug #19340
Stop()
;END CODE
EndFunction
;END FRAGMENT
