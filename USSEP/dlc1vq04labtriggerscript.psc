...
Event OnTriggerEnter(ObjectReference akActionRef)
	...
	;USSEP 4.1.8 Bug #26730
	if pDLC1VQ04.GetStage() >= 90 && pDLC1VQ04.GetStage() < 200
	...
	;USSEP 4.1.8 Bug #26730 - Added to reset people who lost it due to being cured.
	if( pDLC1VQ04.GetStage() >= 200 )
		if( pDLC1VQ04SoulTrapped.GetValue() == 0 )
			pDLC1VQ04QS.IAmVampAgain()
		endif
