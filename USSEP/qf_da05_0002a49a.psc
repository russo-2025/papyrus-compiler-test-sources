...
;BEGIN CODE
Stop() ; Added by USKP 1.3.2 - DA05 never stops running.
;END CODE
EndFunction
;END FRAGMENT
...
Alias_Sinding.GetReference().Disable() ; Added by USKP 1.3.2 to get rid of his duplicate.
