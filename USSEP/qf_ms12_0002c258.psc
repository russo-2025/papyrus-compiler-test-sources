...
Alias_Nurelion.GetActorReference().SetGhost(true)
Alias_Nurelion.TryToAddToFaction(TGNoPickpocketFaction) ; Added by USKP 1.3.3
...
Alias_Nurelion.TryToEvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT
...
Alias_Quintus.TryToEvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT
...
Faction Property TGNoPickpocketFaction Auto ; Added by USKP 1.3.3.
