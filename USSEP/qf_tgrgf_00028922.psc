...
FailAllObjectives()
if GetStageDone(50) == 1 ; check added by USKP
  Game.GetPlayer().RemoveItem(Alias_ItemtoGet.GetReference())
else
  Alias_Mark.GetActorReference().RemoveItem(Alias_ItemtoGet.GetReference())
endif
Stop()
;END CODE
EndFunction
