...
Alias_Dragon.GetReference().DeleteWhenAble() ; USKP 2.0.1 - Dragons not cleaning up!
; USKP 2.0.1 - Stray dogs not cleaning up either, but don't do it if they're the player's follower.
if( AnimalFollower.GetReference() != Alias_Dog.GetReference() )
