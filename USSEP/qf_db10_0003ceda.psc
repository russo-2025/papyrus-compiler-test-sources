...
;END AUTOCAST
;BEGIN CODE
;kmyQuest.pDarkVeezaraDead.Enable() Disabled by USKP 1.3.2 - Veezara's dead ref is enabled in stage 1
...
;BEGIN CODE
Alias_BladeOfWoeAlias.GetReference().Enable() ;USKP 1.3.2 - originally called GetActorRef()
...
Alias_PenitusBoss.GetActorReference().Disable()
Alias_BabetteAlias.GetActorReference().EvaluatePackage()
...
Alias_ArnbjornWerewolfAlias.GetActorReference().Kill()
;END CODE
EndFunction
;END FRAGMENT
...
Alias_AstridEndAlias.GetActorReference().GetActorBase().SetEssential (false)
...
Alias_ArnbjornWerewolfAlias.GetActorReference().SetGhost(False)
Alias_PenitusSoldierArnbjorn1Alias.GetActorReference().SetGhost(False)
Alias_PenitusSoldierArnbjorn2Alias.GetActorReference().SetGhost(False)
;END CODE
EndFunction
;END FRAGMENT
...
;USKP 2.0.4 - This NPC was erroneously attached to an enable parent and must now be enabled manually.
Alias_PenitusBoss.GetActorReference().Enable()
;END CODE
EndFunction
;END FRAGMENT
...
Alias_NazirAlias.GetActorReference().StartCombat(Alias_PenitusSoldier5Alias.GetActorReference())
Alias_PenitusSoldier5Alias.GetActorReference().StartCombat(Alias_NazirAlias.GetActorReference())
;END CODE
EndFunction
;END FRAGMENT
...
Alias_PenitusSoldier5Alias.GetActorReference().GetActorBase().SetEssential (false)
Alias_NazirAlias.GetActorReference().StartCombat(Alias_PenitusSoldier5Alias.GetActorReference())
Alias_PenitusSoldier5Alias.GetActorReference().StartCombat(Alias_NazirAlias.GetActorReference())
Alias_PenitusSoldier5Alias.GetActorReference().AddToFaction(DBAttackPlayerFaction)
;END CODE
EndFunction
;END FRAGMENT
...
Alias_ArnbjornWerewolfAlias.GetActorReference().Enable()
Alias_PenitusSoldierArnbjorn1Alias.GetActorReference().Enable()
Alias_PenitusSoldierArnbjorn2Alias.GetActorReference().Enable()
Utility.Wait(0.1)
Alias_ArnbjornWerewolfAlias.GetActorReference().EvaluatePackage()
Alias_PenitusSoldierArnbjorn1Alias.GetActorReference().EvaluatePackage()
Alias_PenitusSoldierArnbjorn2Alias.GetActorReference().EvaluatePackage()

;Increase the health of Nazir's opponent.
Alias_PenitusSoldier5Alias.GetActorReference().SetAV("Health", Alias_PenitusSoldier5Alias.GetActorReference().GetAV("Health") * 1.5)
;END CODE
EndFunction
;END FRAGMENT
