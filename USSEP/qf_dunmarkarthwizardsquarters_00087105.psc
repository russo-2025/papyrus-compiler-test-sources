...
if (!Alias_Aicantar.GetActorReference().IsDead())
      Alias_Aicantar.TryToMoveTo(Alias_Aicantar.GetActorRef().GetLinkedRef(LinkCustom01))
      Alias_Aicantar.TryToRemoveFromFaction(ReachCrimeFaction)
      Alias_Aicantar.TryToRemoveFromFaction(MarkarthWizardsFaction)
      Alias_Aicantar.TryToRemoveFromFaction(MarkarthKeepFaction)
      Alias_Aicantar.TryToRemoveFromFaction(TownMarkarthFaction)
      Alias_Aicantar.TryToRemoveFromFaction(ServicesMarkarthCastleWizardFaction)
endif
...
Alias_Gallery_Guard01.TryToAddToFaction(SecureAreaGuardFaction)
Alias_Gallery_Guard02.TryToAddToFaction(SecureAreaGuardFaction)
Alias_Gallery_Guard03.TryToAddToFaction(SecureAreaGuardFaction)
Alias_Aicantar.TryToAddToFaction(SecureAreaGuardFaction)
;END CODE
EndFunction
;END FRAGMENT
...
; Move ambushers in.
Alias_Tower_GuardCaptain.TryToMoveTo(Alias_Tower_Ambush04.GetReference())
Alias_Tower_Guard01.TryToMoveTo(Alias_Tower_Ambush02.GetReference())
Alias_Tower_Guard02.TryToMoveTo(Alias_Tower_Ambush03.GetReference())
Alias_Tower_Guard03.TryToMoveTo(Alias_Tower_Ambush01.GetReference())
...
;Close the door.
Utility.Wait(1)
Alias_Tower_Door.GetReference().Lock(True) ; Changed by USKP 1.3.3 - can't use SetOpen on load doors.
;END CODE
EndFunction
;END FRAGMENT
...
; Open door.
Alias_Tower_Door.GetReference().Lock(False) ; Changed by USKP 1.3.3 - can't use SetOpen on load doors.
Utility.Wait(1)
...
if (Alias_Aicantar.GetActorReference().IsDead() == True)
   ...
   Alias_Aicantar.TryToAddToFaction(SecureAreaGuardFaction)
   Alias_Aicantar.GetActorReference().SetAV("Aggression", 1)
   Setstage(91)
endif
;END CODE
EndFunction
...
if (!bRanStage10Setup)
   ...
   Alias_QSTEnableMarker.TryToEnable()
   Alias_Aicantar.TryToMoveTo(Alias_Aicantar.GetActorRef().GetLinkedRef(LinkCustom01))
   Alias_Aicantar.GetActorReference().AddKeyIfNeeded(LabLockedDoor)

   Alias_Gallery_Guard01.TryToReset()
   Alias_Gallery_Guard02.TryToReset()
   Alias_Gallery_Guard03.TryToReset()
   Alias_Gallery_Guard01.TryToMoveTo(Alias_Gallery_Guard01.GetActorReference().GetLinkedRef(LinkCustom01))
   Alias_Gallery_Guard02.TryToMoveTo(Alias_Gallery_Guard02.GetActorReference().GetLinkedRef(LinkCustom01))
   Alias_Gallery_Guard03.TryToMoveTo(Alias_Gallery_Guard03.GetActorReference().GetLinkedRef())

   Alias_Lab_GuardNormal.TryToReset()
...
Alias_BalconyDoor01.GetReference().Lock(False)
Alias_BalconyDoor02.GetReference().Lock(False)
Alias_Lab_Guard01.TryToDisable()
Alias_Lab_Guard02.TryToDisable()
Alias_Lab_Guard03.TryToDisable()
Alias_Lab_Guard04.TryToDisable()
Alias_Lab_Guard05.TryToDisable()
Alias_Lab_Guard06.TryToDisable()
Alias_Lab_Guard07.TryToDisable()
Alias_Lab_Reinforcement1.TryToDisable()
Alias_Lab_Reinforcement2.TryToDisable()
Alias_Lab_Reinforcement3.TryToDisable()
Alias_Lab_Reinforcement4.TryToDisable()
Alias_Lab_Reinforcement5.TryToDisable()
Alias_Lab_Reinforcement6.TryToDisable()
Alias_Lab_Reinforcement7.TryToDisable()
Alias_Lab_Reinforcement8.TryToDisable()
Alias_Tower_Guard01.TryToDisable()
Alias_Tower_Guard02.TryToDisable()
Alias_Tower_Guard03.TryToDisable()
Alias_Tower_GuardCaptain.TryToDisable()
if (!GetStageDone(6))
   Spider.Disable()
   Alias_SpiderStaff.TryToMoveTo(Post1)
   Alias_SpiderJournal.TryToMoveTo(Post2)
EndIf

Alias_Aicantar.TryToRemoveFromFaction(SecureAreaGuardFaction)
Alias_Aicantar.TryToAddToFaction(ReachCrimeFaction)
Alias_Aicantar.TryToAddToFaction(MarkarthWizardsFaction)
Alias_Aicantar.TryToAddToFaction(MarkarthKeepFaction)
Alias_Aicantar.TryToAddToFaction(TownMarkarthFaction)
Alias_Aicantar.TryToAddToFaction(ServicesMarkarthCastleWizardFaction)
Alias_Aicantar.GetActorReference().SetAV("Aggression", 0)
Alias_Aicantar.GetActorReference().MoveToPackageLocation()
;END CODE
EndFunction
;END FRAGMENT
...
; Move ambushers in.
Alias_Tower_GuardCaptain.TryToMoveTo(Alias_Tower_Ambush01.GetReference())
Alias_Tower_Guard02.TryToMoveTo(Alias_Tower_Ambush02.GetReference())
Alias_Tower_Guard01.TryToMoveTo(Alias_Tower_Ambush03.GetReference())
; Debug.Trace("Moving Aicantar to: " + Alias_Tower_Ambush04.GetReference())
Alias_Aicantar.TryToMoveTo(Alias_Tower_Ambush04.GetReference())
