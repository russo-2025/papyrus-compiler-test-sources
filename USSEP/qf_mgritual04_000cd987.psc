...
kmyQuest.RegisterForSingleUpdate(2) ; USKP 2.0.1 - Switched to single updates to kill off serious spam from this quest.
;END CODE
EndFunction
;END FRAGMENT
...
kmyQuest.UnregisterForUpdate() ; Failsafe added by USKP 2.0 to prevent the script from becoming stuck.
Stop()
;END CODE
EndFunction
;END FRAGMENT
