...
Alias_DLC2RR01ModynAlias.TryToMoveTo(pDLC2RR01VelethStartMarker)
Alias_DLC2RR01ModynAlias.TryToEvaluatePackage()
...
Alias_DLC2RR01CariusAlias.GetActorReference().AddItem(Alias_DLC2RR01AltLetterAlias.GetRef())
...
;pDLC2RR01PlansGhoulRef.Enable() - UDBP 2.0.1 commented out because this object doesn't exist.
if Game.GetPlayer().GetItemCount(Alias_DLC2RR01Plans.GetReference()) == 1
SetObjectiveCompleted(30,1)
SetStage(60)
endif
;END CODE
...
;UDBP 2.0.1 - There is no objective 40 to manipulate.
