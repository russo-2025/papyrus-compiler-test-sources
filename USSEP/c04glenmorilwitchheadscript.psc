...
Event OnContainerChanged(ObjectReference akNewContainer, ObjectReference akOldContainer)
	if (akNewContainer == Game.GetPlayer())
		Utility.Wait(0.1)
		If akOldContainer && (akOldContainer.GetBaseObject() == C04GlenmorilWitch) ;USKP 2.0 - Changes in Patch 1.9 script processing cause this to throw errors if the head isn't still on a witch
