...
Event OnActivate(ObjectReference akActivator)
	;USLEEP 3.0.8 Bug #14924 - Should not be possible for something besides a water plane to activate this. For now, log it so we can try and spot why this might happen.
	if( (akActivator as DLC2dunNchardakWaterPlane) == None )
		debug.trace( Self + " was activated by an object that is not a water plane: " + akActivator + " Please report this to the Unofficial Patch team." )
		return
	endif
