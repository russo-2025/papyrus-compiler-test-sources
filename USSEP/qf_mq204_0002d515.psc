...
;Delphine.AddItem(AkaviriKatana) ;USKP 2.1.3 Bug #19383
Esbern.Additem(AkaviriKatana)
Esbern.RemoveItem(EbonyDagger,1) ;USKP 2.1.3 Bug #19383
;END CODE
EndFunction
;END FRAGMENT
...
; word fades away
(Alias_WordClearSkies3.GetReference() as FXGreybeardShoutScript).GoAway()
; advance scene
setstage(83)
;END CODE
EndFunction
...
; word fades away
(Alias_WordClearSkies.GetReference() as FXGreybeardShoutScript).GoAway()
;END CODE
EndFunction
;END FRAGMENT
...
GraybeardTeachFX.Cast(Alias_Arngeir.GetReference(), Alias_WordClearSkies.GetReference())
;END CODE
EndFunction
;END FRAGMENT
...
; word fades away
(Alias_WordClearSkies2.GetReference() as FXGreybeardShoutScript).GoAway()
;END CODE
EndFunction
;END FRAGMENT
...
kmyQuest.AbsorbEffect(Alias_Arngeir.GetActorReference(), 86)
;END CODE
EndFunction
;END FRAGMENT
...
FirebreathWordCount.SetValue(FirebreathWordCount.value + 1) ; USKP 2.0.4 - Fix for globals being unable to cope with += 1 operator.
; enable the correct word
Alias_WordFireBreath.GetReference().enable()

Alias_Paarthurnax.GetActorReference().RestoreActorValue("health", 160)
;END CODE
EndFunction
;END FRAGMENT
...
Alias_Paarthurnax.GetActorReference().Enable()
...
kmyquest.DragonAbsorbEffect(Alias_Paarthurnax.GetActorReference(), 135)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
; cast spell effect towards word
GraybeardTeachFX.Cast(Alias_Arngeir.GetReference(), Alias_WordClearSkies3.GetReference())
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
; cast spell effect towards word
GraybeardTeachFX.Cast(Alias_Arngeir.GetReference(), Alias_WordClearSkies2.GetReference())
;END CODE
EndFunction
;END FRAGMENT
...
Weapon Property EbonyDagger Auto ;USKP 2.1.3 Bug #19383
