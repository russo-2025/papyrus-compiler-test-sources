...
Function LowerWhiterunDrawbridge()
	Debug.Trace(self + "LowerWhiterunDrawbridge()")
	if drawbridgeUp == true
		Alias_WhiterunDrawbridge.GetReference().PlayGamebryoAnimation("Backward", TRUE)
		drawbridgeUp = false
		LowerWhiterunDrawbridgeDelayed()
	endif
EndFunction
...
Function RaiseWhiterunDrawbridge()
	Debug.Trace(self + "RaiseWhiterunDrawbridge()")
	if drawbridgeUp == false
...
Function Fragment_10()
	...
	if cityVar == kmyquest.CWs.WhiterunLocation
		Fragment_10_WhiterunSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.MarkarthLocation
		Fragment_10_MarkathSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.RiftenLocation
		Fragment_10_RiftenSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.SolitudeLocation
		Fragment_10_SolitudeSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.WindhelmLocation
		Fragment_10_WindhelmSetup(kmyQuest)
	endif
	;END CODE
EndFunction
...
Function Fragment_27()
	...
	Location cityVar = Alias_City.GetLocation()
	if cityVar == kmyquest.CWs.WhiterunLocation
		Fragment_27_WhiterunSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.MarkarthLocation
	...
	elseif cityVar == kmyquest.CWs.WindhelmLocation
		Fragment_27_WindhelmSetup(kmyQuest)
	endif
...
;This section added by the Unofficial Skyrim Patch
	if cityVar == kmyquest.CWs.WhiterunLocation
		...
		EndIf
	EndIf
;End section added by the Unofficial Skyrim Patch
	;END CODE
EndFunction
...
Function Fragment_22()
	...
	Location cityVar = Alias_City.GetLocation()
	if cityVar == kmyquest.CWs.WhiterunLocation
		Fragment_22_WhiterunSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.MarkarthLocation

	elseif cityVar == kmyquest.CWs.RiftenLocation

	elseif cityVar == kmyquest.CWs.SolitudeLocation
		Fragment_22_SolitudeSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.WindhelmLocation
		 Fragment_22_WindhelmSetup(kmyQuest)
	endif
	;END CODE
EndFunction
...
Function Fragment_21()
	...
	;**CITY SPECIFIC:
	if cityVar == kmyquest.CWs.WhiterunLocation
		Fragment_21_WhiterunSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.MarkarthLocation
		Fragment_21_MarkarthSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.RiftenLocation
		Fragment_21_RiftenSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.SolitudeLocation
		Fragment_21_SolitudeSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.WindhelmLocation
...
Function Fragment_21_WhiterunSetup(CWSiegeScript kmyQuest)
	if kmyquest.IsAttack()
		...
		kmyquest.WhiterunAmbExt01.Disable()
		kmyquest.WhiterunAmbExt02.Disable()
		kmyquest.WhiterunAmbExt03.Enable()
...
Function Fragment_5()
	...
	if kmyquest.CWs.ImperialsAreAttacking(Alias_City.GetLocation())
		...
		Alias_CampEnableMarkerSons.GetReference().Enable()
	...
	; CWScript.Log("CWSiegeQuestFragmentScript", self + "Turning on the appropriate advanced soldiers based on player's allegiance")
		...
		elseif kmyQuest.CWs.GetAttacker(Alias_City.GetLocation()) == kmyQuest.CWs.iSons	;Player is an Sons, and is attacking
			(Alias_AttackerSonsReinforceEnabler.GetReference()).Enable()
		endif
	...
	Alias_MainGateExterior.GetReference().BlockActivation()
	...
	; 		;CWScript.Log("CWSiegeQuestFragmentScript", self + "Setting correct general based on players allegience.")
			;if kmyquest.CWs.ImperialsAreAttacking(Alias_City.GetLocation())
			;	(Alias_ImpRikke.GetReference()).MoveTo(Alias_AttackerImperial1.GetReference())
			;	(Alias_AttackerImperial1.GetReference()).Disable()
			;	Alias_AttackerImperial1.ForceRefTo(Alias_ImpRikke.GetReference())
			;	Alias_Attacker1General.ForceRefTo(Alias_ImpRikke.GetReference())
			;else
			;	(Alias_SonsGalmar.GetReference()).MoveTo(Alias_AttackerSons1.GetReference())
			;	(Alias_AttackerSons1.GetReference()).Disable()
			;	Alias_AttackerSons1.ForceRefTo(Alias_SonsGalmar.GetReference())
			;	Alias_Attacker1General.ForceRefTo(Alias_SonsGalmar.GetReference())
			;endif
	...
	; 		CWScript.Log("CWSiegeQuestFragmentScript", self + "Setting initial CWBattlePhase")
		...
		;if either attack or defense
		;if either attack or defense
		Alias_WhiterunCaravanMarker.GetReference().Disable()
		Alias_WhiterunCaravanActor01.GetReference().Disable()
		Alias_WhiterunCaravanActor02.GetReference().Disable()
		Alias_WhiterunCaravanActor03.GetReference().Disable()
		Alias_WhiterunCaravanActor04.GetReference().Disable()
		Alias_WhiterunExtEnableOnly.GetReference().Enable()
		Alias_WhiterunExtDisableOnly.GetReference().Disable()
		(Alias_WhiterunDisableNearbyGarrisonEnableMarker1.GetReference()).Disable()
		(Alias_WhiterunDisableNearbyGarrisonEnableMarker2.GetReference()).Disable()
		(Alias_WhiterunDisableNearbyGarrisonEnableMarker3.GetReference()).Disable()
		(Alias_WhiterunDisableNearbyGarrisonEnableMarker4.GetReference()).Disable()
	...
	;if either attack or defense
		(Alias_MarkarthDisableNearbyGarrisonEnableMarker1.GetReference()).Disable()
	...
	; 		CWScript.Log("CWSiegeQuestFragmentScript", self + "Setting initial CWBattlePhase")
		...
		Alias_WindhelmCaravanMarker.GetReference().Disable()
		Alias_WindhelmDockGate.GetReference().SetLockLevel(255)
		Alias_WindhelmDockGate.GetReference().Lock()
	...
	kmyquest.CWs.AddEnemyFortsToBackToWar()
...
Function Fragment_34()
	...
	if cityVar == kmyquest.CWs.WhiterunLocation
		Fragment_34_WhiterunSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.MarkarthLocation
		Fragment_34_MarkarthSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.RiftenLocation
		Fragment_34_RiftenSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.SolitudeLocation
		Fragment_34_SolituteSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.WindhelmLocation
		Fragment_34_WindhelmSetup(kmyQuest)
	endif
	;END CODE
EndFunction
...
Function Fragment_18()
	...
	if cityVar == kmyquest.CWs.WhiterunLocation
		Fragment_18_WhiterunSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.MarkarthLocation
		Fragment_18_MarkarthSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.RiftenLocation
		Fragment_18_RiftenSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.SolitudeLocation
		Fragment_18_SolitudeSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.WindhelmLocation
		Fragment_18_WindhelmSetup(kmyQuest)
	endif
...
Function Fragment_11()
	...
	if cityVar == kmyquest.CWs.WhiterunLocation
		Fragment_11_WhiterunSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.MarkarthLocation
		Fragment_11_MarkarthSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.RiftenLocation
		Fragment_11_RiftenSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.SolitudeLocation
		Fragment_11_SolitudeSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.WindhelmLocation
		Fragment_11_WindhelmSetup(kmyQuest)
	endif
	;END CODE
EndFunction

Function Fragment_11_WhiterunSetup(CWSiegeScript kmyQuest)
	RaiseWhiterunDrawbridge()
...
Function Fragment_37()
	...
	if cityVar == kmyquest.CWs.WhiterunLocation
		Fragment_37_WhiterunSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.MarkarthLocation
		Fragment_37_MarkarthSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.RiftenLocation
		Fragment_37_RiftenSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.SolitudeLocation
		Fragment_37_SolitudeSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.WindhelmLocation
		Fragment_37_WindhelmSetup(kmyQuest)
	endif
	;END CODE
EndFunction
...
Function Fragment_25()
	...
	Location cityVar = Alias_City.GetLocation()
	if cityVar == kmyquest.CWs.WhiterunLocation
		Fragment_25_WhiterunSetup(kmyQuest)
	...
	; 	;CWScript.Log("CWSiegeQuestFragmentScript", self + "Stage 200, stopping polling player location")	;*** WRITE TO LOG
		...
		EnforceDrawbridgeCollisionState(cityVar, kmyquest)
	endif
	;END CODE
EndFunction
...
Function Fragment_17()
	...
	if cityVar == kmyquest.CWs.WhiterunLocation
		 Fragment_17_WhiterunSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.MarkarthLocation
		 Fragment_17_MarkathSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.RiftenLocation
		Fragment_17_RiftenSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.SolitudeLocation
		Fragment_17_SolitudeSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.WindhelmLocation
		Fragment_17_WindhelmSetup(kmyQuest)
	endif
	;END CODE
EndFunction
...
Function Fragment_0()
	...
	if cityVar == kmyquest.CWs.WhiterunLocation
		...
		if kmyquest.IsAttack()
			...
			kmyquest.CWSiegeObjGeneral.ForceRefTo(Alias_Defender1General.GetReference())
			kmyquest.CWSiegeObjObjective2A.ForceRefTo(Alias_WhiterunDrawbridgeOBJ.GetReference())  ;Whiterun Drawbridge on defense
		endif
...
Function Fragment_6()
	...
	if cityVar == kmyquest.CWs.WhiterunLocation
		Fragment_6_WhiterunSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.MarkarthLocation
		Fragment_6_MarkarthSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.RiftenLocation
		Fragment_6_RiftenSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.SolitudeLocation
		Fragment_6_SolitudeSetup(kmyQuest)
	elseif cityVar == kmyquest.CWs.WindhelmLocation
		Fragment_6_WindhelmSetup(kmyQuest)
	endif
	;END CODE
EndFunction
