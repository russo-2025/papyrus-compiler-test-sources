...
;USSEP 4.2.4 Bug #29333 - Let's process this here now, shall we?
Function USSEP_RealSetupCompanions()
...
;The original function calls on our event now instead.
Event OnUpdate()
	USSEP_RealSetupCompanions()
EndEvent
