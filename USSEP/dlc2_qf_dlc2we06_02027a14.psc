...
;Check added by UDBP 1.0.4 to see if the player already has the book.
Book BlackBook = (Alias_BlackBook.GetReference().GetBaseObject() as Book)
if( Game.GetPlayer().GetItemCount(BlackBook) > 0 )
 SetStage(200)
endif
;END CODE
EndFunction
