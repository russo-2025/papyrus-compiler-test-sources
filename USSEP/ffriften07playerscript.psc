...
Event OnItemRemoved(Form akBaseItem, int aiItemCount, ObjectReference akItemReference, ObjectReference akDestContainer)
	...
	if( pFFR07Quest.GetStageDone(20) == 1 && pFFR07Quest.GetStageDone(200) == 0 ) ;Stage 200 check added by USKP to prevent the quest from recycling objectives at the end.
		if akBaseItem == pTeeth
			pFFR07QS.TeethCounted()
		endif
	endif
