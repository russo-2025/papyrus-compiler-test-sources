...
if pFFRiften03Arrested.Value == 0
 Alias_FFRiften03RomlynAlias.GetActorReference().SetRelationshipRank(Game.GetPlayer(), 1)
else
 Alias_FFRiften03IndarynAlias.GetActorReference().SetRelationshipRank(Game.GetPlayer(), 1)
endif
pFFRTQS.ThaneCheck()
