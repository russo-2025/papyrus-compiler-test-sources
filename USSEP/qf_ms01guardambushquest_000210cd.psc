...
;USKP Bug #19389
Actor EltrysDead = Alias_EltrysDead.GetActorReference()
(EltrysDead as WIDeadBodyCleanupScript).GoToState("Dead")
(EltrysDead as WIDeadBodyCleanupScript).cleanUpBody()
;END CODE
EndFunction
;END FRAGMENT
