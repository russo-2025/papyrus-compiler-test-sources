...
Scriptname QF_APS_HouseWinterhold_063A5DDB Extends Quest Hidden
...
(purchaseHouse as BYOHRelationshipAdoptionHousePurchase).Windhelm_EnableChildBedroom()
int i = 0
...
disableMarkers[0].disable()
disableMarkers[1].disable()
